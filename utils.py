...
def tmp_load_ImageNet_testset(data_name = 'CIFAR10', data_dir = './data', batch_size = 128, num_workers = 1,pin_memory = True,scale_size = 224):
	valdir   = os.path.join(data_dir, 'ILSVRC2012_img_val')
	normalize = transforms.Normalize(mean=[0.485, 0.456, 0.406],std=[0.229, 0.224, 0.225])
	testset = datasets.ImageFolder(
			valdir,
...
def load_ImageNet_demo(data_name = 'CIFAR10', data_dir = './data', batch_size = 128, num_workers = 1,pin_memory = True,scale_size = 224):
	valdir   = os.path.join(data_dir, 'ILSVRC2012_img_val_demo')
	normalize = transforms.Normalize(mean=[0.485, 0.456, 0.406],std=[0.229, 0.224, 0.225])
	testset = datasets.ImageFolder(
			valdir,
			transforms.Compose([
